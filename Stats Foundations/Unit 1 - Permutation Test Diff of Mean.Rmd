...
The result is not significant at p < 0.05, therefore, we __Fail to Reject the Null Hypothesis__
...
cat("\n Number of values greater than the observed mean difference: ", sum(abs(perm_result) > diff_mean))
pvalue <- sum(abs(perm_result) > diff_mean) / nperm
